...
public class GenericRestTest_XML extends BridgeAdapterTestBase{
    ...
    public String getConfigFilePath() {
        return "src/test/resources/bridge-config-xml.yml";
    }
    ...
    public void test_singleRetrieveWithParams() throws Exception {
        ...
        request.setQuery("/<%=parameter[\"Id\"]%>:$.Travelerinformation");
    ...
    public void test_singleRetrieve_NestedJSONPath() throws Exception {
        ...
        request.setQuery(":$.TravelerinformationResponse");
    ...
    public void test_order(){
        ...
        request.setStructure(getStructure());
        request.setFields(getFields());
        request.setQuery(":$.TravelerinformationResponse.travelers.Travelerinformation");
